...
class Broker:
    def __init__(self, config):
        ...
        ELASTIC_PASSWORD = "AwsOmc-8sPbj_6ZAPkPc"
        es = elasticsearch.Elasticsearch(
        "https://localhost:9200",
        ca_certs="C:\\Users\saipa\Documents\AWS Cloud details\elasticsearch-8.3.1\config\certs\http_ca.crt",
        ...
        if self.noTypes:
            ...
            if self.seven:
                ...
                print(es_config['database'])
                print("Check value : ", es.indices.exists(index = es_config['database'] + "_api"))
            else:
